#!/usr/bin/env python3
"""
End-to-End Test Script for PayKit SDK.
...
from paykit import Config, Network
...
def test_ensure_setup(api_key: str | None = None):
    ...
    from paykit.onboarding import ensure_setup
...
def test_transfer_operations(service: WalletService, wallet):
    ...
    try:
        ...
        from paykit.core.types import TransactionInfo, TransactionState
        from paykit.wallet.service import TransferResult
...
def main(api_key: str | None = None):
    ...
    print("\n" + "🚀" * 20)
    print("   PayKit SDK - End-to-End Test")
    print("🚀" * 20)
