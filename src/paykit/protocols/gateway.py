...
from paykit.core.logging import get_logger
...
from paykit.protocols.base import ProtocolAdapter
...
class GatewayAdapter(ProtocolAdapter):
    ...
    async def _execute_cctp_transfer(
        ...
        """
        from paykit.core.cctp_constants import (
            CCTP_DOMAIN_IDS,
            DEFAULT_MAX_FEE,
        ...
        if source_network != Network.ARC_TESTNET:
            try:
                from paykit.utils.gas import check_gas_requirements
    ...
    async def simulate(
        ...
        **kwargs: Any,
        ...
        from paykit.core.cctp_constants import is_cctp_supported
    ...
    async def _mint_usdc(
        ...
        """
        from paykit.core.cctp_constants import get_message_transmitter_v2
