"""
Exception hierarchy for PayKit SDK.

All SDK-specific exceptions inherit from PayKitError for easy catching.
"""
...
class PayKitError(Exception):
    """
    Base exception for all PayKit SDK errors.
...
class PaymentError(PayKitError):
    """
...
class ValidationError(PayKitError):
    """
