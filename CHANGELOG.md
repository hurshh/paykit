...
All notable changes to PayKit will be documented in this file.
...
- **Core Payment Infrastructure**
  - `PayKit` client for autonomous AI agent payments
...
[0.0.2]: https://github.com/paykit/paykit/releases/tag/v0.0.2
