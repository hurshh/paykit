# PayKit: The Payment Infrastructure Layer for AI Agents
...
**PayKit** is the payment *execution* infrastructure for AI agents. While protocols like x402 define payment standards and Google's AP2 defines authorization frameworks, PayKit is the SDK that makes payments actually happen.
...
│                                    ▼                                       │
│  ┌──────────────────────────────────────────────────────────────────────┐ │
│  │ LAYER 1: EXECUTION INFRASTRUCTURE  ⭐ THIS IS AGENTPAY           │ │
│  │                                                                       │ │
│  │ PayKit                                                          │ │
...
```
AGENT A (Research)              AGENTPAY              AGENT B (Analysis)
      │                              │                           │
...
*Native Claude/AI support*: PayKit as an MCP server.
...
→ Automatically routes to PayKit MCP tool
...
| Competitor Gap | PayKit Solution |
|----------------|----------------------|
