...
from paykit.core.types import Network, PaymentMethod, PaymentStatus
from paykit.protocols.x402 import (
    X402Adapter,
    PaymentRequirements,
    PaymentPayload,
)
...
class TestX402Adapter:
    ...
    async def test_cross_chain_detection(self, adapter, mock_wallet_service):
        ...
        with patch.object(adapter, '_request_with_402_check', new_callable=AsyncMock) as mock_request:
            ...
            with patch('paykit.protocols.gateway.GatewayAdapter') as mock_gateway:
