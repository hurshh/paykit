"""
Example: Gemini Agent with PayKit
---------------------------------------
Demonstrates how to integrate PayKit with Google's Gemini models
...
from paykit import Network, PayKit  # noqa: E402
...
async def pay_tool(recipient: str, amount: str, purpose: str = "Payment") -> dict:
    ...
    # Initialize PayKit (Auto-config from env)
    # Using Arc Testnet for Hackathon
    async with PayKit(network=Network.ARC_TESTNET) as client:
