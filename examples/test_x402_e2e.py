...
sys.path.append(os.path.abspath("paykit/src"))

from paykit import PayKit  # noqa: E402
from paykit.core.types import TransactionInfo, TransactionState  # noqa: E402
from paykit.wallet.service import TransferResult  # noqa: E402
...
async def main():
    ...
    client = PayKit(circle_api_key="sk_test_mock", entity_secret="mock_secret")
